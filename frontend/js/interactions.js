...
function startDemoAnimation() {
    ...
    // Animate chart drop
    setTimeout(() => {
        floatingChart.classList.add('animate');
    }, 300);
    
    // Chart drops into upload zone
    setTimeout(() => {
        floatingChart.classList.add('drop');
    }, 2000);
...
function resetDemoAnimation() {
    ...
    // Reset all states
    floatingChart.classList.remove('animate', 'drop');
